...
public class AllCommandsConstants {
    ...
    public static final double GRIPPER_BACK_LOADING_VOLTAGE = 6;
    public static final double GRIPPER_LEFT_LOADING_VOLTAGE = 6;
    public static final double GRIPPER_RIGHT_LOADING_VOLTAGE = 6;
    ...
    public static final double GRIPPER_OUTTAKE_L3_VOLTAGE = -12;
    public static final double GRIPPER_BACK_L3_VOLTAGE = 0;
